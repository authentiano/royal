...
class CellMemberSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CellMember
        fields = [
            "id", "cell", "member", "member_id", "member_details",
            "status", "joined_date", "notes", "created_at", "updated_at"
        ]
...
class CellSerializer(serializers.ModelSerializer):
    ...
    members = CellMemberSerializer(many=True, read_only=True)

    class Meta:
        model = Cell
        fields = [
            "id", "name", "description", "meeting_day", "meeting_time",
            "location", "leader", "leader_id", "leader_details",
